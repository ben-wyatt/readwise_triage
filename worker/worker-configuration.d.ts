/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: b50e9f9b1e07b2de99aa50f9fb26837f)
...
interface __BaseEnv_Env {
	...
	SCORE_CURVE: "sqrt";
	ENABLE_READ_HISTORY: "false";
	READ_HISTORY_WEIGHT: "0.5";
	ENABLE_LENGTH_SIGNAL: "false";
	LENGTH_SIGNAL_WEIGHT: "0.2";
	JUST_IN_DAYS: "14";
	LONG_READ_MIN_WORDS: "2500";
	SHORT_BLOG_MAX_WORDS: "1200";
	PROMOTE_TAG: "triage";
	READWISE_MAX_REQUESTS_PER_MIN: "20";
	BOOTSTRAP_MAX_PAGES_PER_RUN: "5";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DRY_RUN" | "SCORING_WINDOW_DAYS" | "MAX_ITEMS_PER_BUCKET" | "SCORE_CURVE" | "ENABLE_READ_HISTORY" | "READ_HISTORY_WEIGHT" | "ENABLE_LENGTH_SIGNAL" | "LENGTH_SIGNAL_WEIGHT" | "JUST_IN_DAYS" | "LONG_READ_MIN_WORDS" | "SHORT_BLOG_MAX_WORDS" | "PROMOTE_TAG" | "READWISE_MAX_REQUESTS_PER_MIN" | "BOOTSTRAP_MAX_PAGES_PER_RUN">> {}
}
